...
public class FacturaDet implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FACTURA_DET_GENERATOR", sequenceName="SEQ_FACTURA_DET",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FACTURA_DET_GENERATOR")
